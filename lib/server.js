...
server.unifiedServer = function(req,res){
   ...
   // if its a database request check for a signifier
   var reason = '';
   if (req.reason) {
   ...
   req.on('end', function() {
       ...
       // Construct the data object to send to the handler based on the content type
...
server.router = {
  ...
  'api/contacts' : handlers.contacts,
